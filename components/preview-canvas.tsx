...
function drawImageCentered(
  ...
  areaWidth: number,
  areaHeight: number,
  offsetY: number = 0 // Vertical offset in pixels (negative = upward)
) {
  ...
  // Center the scaled image in the area, apply vertical offset
  const drawX = x + (areaWidth - drawWidth) / 2
  const drawY = y + (areaHeight - drawHeight) / 2 + offsetY
